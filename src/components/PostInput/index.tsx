    ...
    return (
        <div className="flex flex-col p-3 border-b-[1px]">
            <div className="flex h-full pr-2">
                ...
                <span className="post-input min-h-[42px] max-h-[175px] break-all block overflow-scroll overflow-x-hidden overflow-y-auto" ref={editableRef} contentEditable="plaintext-only" role="textbox" data-placeholder="What's on your mind..." onInput={onInput}></span>
            </div>
